...
When about three successive exchanges produce no new contribution from the student, the skill SHALL name the impasse plainly, record the state in the notes file, suggest concrete offline steps — reading the group's page, talking to the supervisor or fellow students — and end the session without seeding a proposal file.
