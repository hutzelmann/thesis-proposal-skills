...
- [x] 5.1 Full L0 + lint pass (`pytest tests/unit`, `ruff check`, `sync_shared.py --check`) — 66 passed, ruff clean, copies in sync
- [x] 5.2 `openspec validate reduce-skill-duplication --strict`; commit the change
