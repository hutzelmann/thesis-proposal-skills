...
The subtitle states whether this is a Bachelor's or a Master's proposal, and that wording is the only place the level is recorded — the skeleton above is identical at both levels by design, because the qualification frameworks and assessment literature locate the difference in graded expectations, not structure (sources: `docs/degree-level-sources.md` in the skill repository). Four expectations grade with the level. **Contribution:** a Bachelor's proposal may close its contribution section by promising to apply or evaluate something competently in a named setting — a novelty claim is not required, though one is welcome; a Master's proposal names what will be new and for whom. Demanding a novelty claim from a Bachelor's proposal is the same error as accepting its absence from a Master's proposal. **Research questions:** deriving them from a topic the supervisor or group provided is the level-appropriate move at Bachelor's level; at Master's level they grow out of the gap the contribution section argues. **Literature:** established anchors — textbooks, surveys, canonical papers — legitimately carry a Bachelor's proposal alongside selected current work; a Master's proposal engages recent primary literature closely enough that the gap emerges from the engagement. **Scope:** the plan must be deliverable in the available months at the declared level; a Bachelor's plan carrying a Master's-scale evaluation is over-scoped, and the reverse undershoots. Neither level requires a statement justifying the methodology choice: the proposal declares one methodology and the proposal as a whole is its support — whether the choice fits the research questions is judged in review, not written as defense.
